...
//};
//
//void DrawSkyboxPass::Setup(RHIContext* context, CameraInfo* cameraData)
//{
...
//}
//
//void DrawSkyboxPass::Execute(RHIContext* context, CameraInfo* cameraData)
//{
...
//}
//
//void DrawSkyboxPass::UpdateRenderTarget(CameraInfo *cameraData)
//{
//	for (int i = 0; i < 3; ++i)
//	{
