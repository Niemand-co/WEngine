#include "pch.h"
#include "Windows/Public/WindowsRenderer.h"
#include "Render/Public/Rasterizer.h"
...
//void WindowsRenderer::DrawByIndices(GameObject* entity, Light* light, Camera* camera)
//{
//	int step = 3;
