...
namespace Vulkan
{
	...
	public:
		...
		int32 AcquireImageIndex(class VulkanSemaphore** OutSemaphore);

		int32 Present(RHIQueue* Queue, class VulkanSemaphore* RenderingDoneSemaphore);
	...
	private:
		...
		WEngine::WArray<VulkanSemaphore*> ImageAcquireSemaphore;
